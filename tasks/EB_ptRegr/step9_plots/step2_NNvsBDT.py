...
def plot_results(bdt, NN, eta_bins=None, plot_distributions=False):
    ...
    eta_bins, centers, medians, perc5s, perc95s, perc16s, perc84s, residuals, variances, n = plot_ptratio_distributions_n(df,ptratio_dict,genpt_,eta_, genpt_bins=np.linspace(1,100,34), eta_bins=eta_bins, plots=plot_distributions, savefolder="plots/step2_NNvsBDT")
    ...
    resolution_plot(ptratio_dict, eta_bins, centers, perc16s, perc84s, variances=variances, n=n, savefolder="plots/step2_NNvsBDT")
